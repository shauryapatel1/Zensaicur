/*
  # Fix interval vs integer comparison in streak calculation functions
  
  1. Changes
    - Fixed type mismatch between interval and integer in streak calculation functions
    - Added proper EXTRACT(DAY FROM ...) to convert intervals to integers
    - Improved date difference calculations in recalculate_streaks_for_user
    - Fixed streak badge update logic
  
  2. Reason
    - Resolves error: "operator does not exist: interval <> integer"
    - Ensures proper type handling in date comparisons
*/
...
BEGIN
    ...
    LOOP
        ...
        ELSE
            ...
            date_diff := (last_date - current_date);
